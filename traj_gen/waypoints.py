...
def traj_from_file(file: str,
                   path: str = '/home/dev/ros2_ws/src/trajectory/rov_position_snapshot/output'):
    ...
    for point in data['data']:
        ...
        rx, ry, rz = euler_from_quaternion(x=point['orientation']['x'],
        ...
        t.append(point['time'] * data['time_ratio'])
